...
if(isset($_POST['name'])){
    ...
    $phone = $_POST['phone'];
    $desc = $_POST['desc'];
    $dup=mysqli_query($con, "SELECT * FROM `trip` where email = '$email' ");
    if(mysqli_num_rows($dup)>0){
         echo "IT is duplicate entry";
    }else{
...
<body>
    ...
    <div class="container">
        <h3>
            Welcome to Garden city University US Trip form
        </h3>
        ...
        ?>
        <form action="ustrip_form.php" method="post">
